<div class="relative w-auto h-auto">
    <div
                ...
                <div class='relative flex items-start justify-center p-4'>
                    ...
                    <div class='flex flex-col'>
                        ...
                        <div class='flex mt-3 gap-2'>
                            <button type='button' @click='burnToast(toast.id)' class='inline-flex items-center gap-2 justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 px-3 py-1.5 bg-primary text-primary-foreground hover:bg-primary/80 active:bg-primary/90'>Accept</button>
                            <button type='button' @click='burnToast(toast.id)' class='inline-flex items-center gap-2 justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 px-3 py-1.5 border bg-transparent text-foreground hover:bg-accent/80 hover:text-accent-foreground active:bg-accent'>Decline</button>
                        </div>
                    </div>
                </div>
            `
        ...
        <!--
        <div class="relative">
            <p class="mb-2 text-xs font-medium text-center text-muted-foreground sm:text-left">Types</p>
            <div class="relative flex flex-col px-10 space-y-2 sm:space-x-5 sm:space-y-0 sm:flex-row sm:px-0">
                <button @click="title='Default Toast Notification'; type='default'; description=''; popToast()"
                        ...
                        class="inline-flex items-center justify-center flex-shrink-0 px-3 py-1 text-xs font-medium transition-colors border rounded-md h-9 hover:bg-background active:bg-white focus:bg-white focus:outline-none">
                    Default
                </button>
                <button
        ...
        <div class="relative">
            <p class="mb-2 text-xs font-medium text-center text-muted-foreground sm:text-left">Position</p>
            <div class="relative flex flex-col px-10 space-y-2 sm:space-x-5 sm:space-y-0 sm:flex-row sm:px-0">
        ...
        <div class="relative">
            <p class="mb-2 text-xs font-medium text-center text-muted-foreground sm:text-left">Layout</p>
            <div class="relative flex flex-col px-10 space-y-2 sm:space-x-5 sm:space-y-0 sm:flex-row sm:px-0">
                <button
                ...
                >
                    ...
                    >
                        ...
                        <span
                            ...
                            class="absolute right-0 p-1.5 mr-2.5 text-gray-400 duration-100 ease-in-out rounded-full opacity-0 cursor-pointer hover:bg-background hover:text-muted-foreground"
